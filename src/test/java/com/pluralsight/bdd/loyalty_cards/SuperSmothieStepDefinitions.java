...
public class SuperSmothieStepDefinitions  {
    ...
    private SuperSmothieSchema superSmothieSchema = new SuperSmothieSchema(drinkCatalog);
    ...
    public void the_following_drink_categories(List<Map<String, String>> drinkCategories) {
        drinkCategories.stream().forEach(
                drinkCategory -> {
                    ...
                    superSmothieSchema.setPointsPerCategory(category, points);
    ...
    public void michael_is_a_Morning_Freshness_Member(String name) {
        michael = new MorningFreshnessMember(name, superSmothieSchema);
    }
